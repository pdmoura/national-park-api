  ...
  try {
    ...
    await Alert.insertMany([
      ...
      },
      {
        parkId: parks[1]._id,
        title: "Bear Warning",
        description: "High bear activity.",
        category: "warning",
      ...
      },
      {
        parkId: parks[2]._id,
        title: "Information",
        description: "Visitor center hours updated.",
        category: "info",
    ...
    await Campground.insertMany([
      ...
      },
      {
        ...
        description: "Near Madison River.",
        numSites: 270,
        cost: "$25",
        season: "Summer",
        latitude: "44.645",
    ...
    await Review.insertMany([
      ...
      },
      {
        ...
        userId: users[1].githubId,
        rating: 4,
        title: "Great Wildlife",
        comment: "Saw bison and elk.",
      ...
      },
      {
        ...
        comment: "Half Dome is breathtaking.",
    ...
    await Trail.insertMany([
      {
        ...
        description: "Access to Crater Lake shore.",
        distance: "2.2 miles",
      ...
      },
      {
        ...
        description: "Scenic waterfall hike.",
        distance: "5 miles",
      ...
      },
      {
        parkId: parks[2]._id,
        name: "Mist Trail",
        description: "Leads to Vernal and Nevada Falls.",
        distance: "7 miles",
    ...
    await Wildlife.insertMany([
      {
        ...
        category: "bird",
        description: "Known for hoarding pine seeds.",
      ...
      },
      {
        ...
        category: "mammal",
        description: "Large omnivorous bear.",
